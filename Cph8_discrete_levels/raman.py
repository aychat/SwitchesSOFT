...
class Propagator(FCfactors, MUBQHamiltonian):
    ...
    def __init__(self, **kwargs):
        ...
        self.level[self.num_levels:2*self.num_levels] = self.energies_excited[:self.num_levels]/1.87855 + 1
...
if __name__ == '__main__':
    ...
    #
    # spectra1 /= spectra2.max()
    # spectra2 /= spectra2.max()
    # plt.figure()
    # plt.title('Cph1 absorption spectra')
    # plt.plot(660. / freq, spectra1, 'k', label='mol1')
    # plt.plot(660. / freq, spectra2, 'r', label='mol2')
    # plt.grid()
    ...
    plt.subplot(211)
    plt.title('Cph1 absorption spectra')
    plt.plot(15151.528 * freq, spectra1, 'r', label='Excited_electronic')
    plt.plot(15151.528 * freq, spectra2, 'k', label='Excited_electronic')
    plt.legend()
    plt.grid()
    plt.subplot(212)
    plt.plot(15151.528 * freq, raman1, 'r', label='Raman_g1_mol1')
    plt.plot(15151.528 * freq, raman2, 'k', label='Raman_g1_mol2')

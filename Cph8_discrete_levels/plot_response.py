...
plt.plot(omega.reshape(-1)*1e6, calculate_pol_a1_12(omega10_M1, gamma10_M1, omega20_M1, gamma20_M1).real, 'r', label='Molecule1')
plt.plot(omega.reshape(-1)*1e6, calculate_pol_a1_12(omega10_M2, gamma10_M2, omega20_M2, gamma20_M2).real, 'k', label='Molecule2')
plt.legend()
plt.grid()
plt.xlabel("freq (in GHz)")

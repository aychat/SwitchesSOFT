...
if __name__ == '__main__':
    ...
    def calculate_spectra(params):
        ...
        c_qsys_params = qsys_params.copy()
        c_qsys_params['disp'] = params[0]
        c_qsys_params['freq_Vg'] = params[1]
        c_qsys_params['freq_Ve'] = params[1]

        molecule = RhoPropagate(**c_qsys_params)
        ...
        for k in range(N):
            ...
            spectra[k] = np.trace(molecule.rho_e).real
            delta_freq[k] = molecule.delt
            print delta_freq[k], spectra[k]

...
typedef struct{
	...
	gsl_matrix_complex *env_term_4_5;
	gsl_matrix_complex *env_term_5_6;
	gsl_matrix_complex *env_term_6_7;
	gsl_matrix_complex *env_term_7_8;
	gsl_matrix_complex *env_term_8_1;

	gsl_matrix_complex *env_term_10_11;
	gsl_matrix_complex *env_term_11_12;
	gsl_matrix_complex *env_term_12_13;
	gsl_matrix_complex *env_term_13_14;
	gsl_matrix_complex *env_term_14_15;
	gsl_matrix_complex *env_term_15_16;
	gsl_matrix_complex *env_term_16_9;
...
//----------------------------------------------------//
{
	...
	const double gamma_4_5 = params->gamma_4_5;
	const double gamma_5_6 = params->gamma_5_6;
	const double gamma_6_7 = params->gamma_6_7;
	const double gamma_7_8 = params->gamma_7_8;
	const double gamma_8_1 = params->gamma_8_1;

	const double gamma_10_11 = params->gamma_10_11;
	const double gamma_11_12 = params->gamma_11_12;
	const double gamma_12_13 = params->gamma_12_13;
	const double gamma_13_14 = params->gamma_13_14;
	const double gamma_14_15 = params->gamma_14_15;
	const double gamma_15_16 = params->gamma_15_16;
	const double gamma_16_9 = params->gamma_16_9;
	...
	environment_term(qmat, 4, 3, gamma_4_5, params->env_term_4_5, params); 
	environment_term(qmat, 5, 4, gamma_5_6, params->env_term_5_6, params); 
	environment_term(qmat, 6, 5, gamma_6_7, params->env_term_6_7, params);
	environment_term(qmat, 7, 6, gamma_7_8, params->env_term_7_8, params); 
	environment_term(qmat, 0, 7, gamma_8_1, params->env_term_8_1, params);

	environment_term(qmat, 10, 9, gamma_10_11, params->env_term_10_11, params); 
	environment_term(qmat, 11, 10, gamma_11_12, params->env_term_11_12, params);
	environment_term(qmat, 12, 11, gamma_12_13, params->env_term_12_13, params); 
	environment_term(qmat, 13, 12, gamma_13_14, params->env_term_13_14, params); 
	environment_term(qmat, 14, 13, gamma_14_15, params->env_term_14_15, params);
	environment_term(qmat, 15, 14, gamma_15_16, params->env_term_15_16, params); 
	environment_term(qmat, 8, 15, gamma_16_9, params->env_term_16_9, params);
	...
	gsl_matrix_complex_add(params->H_q, params->env_term_4_5);
	gsl_matrix_complex_add(params->H_q, params->env_term_5_6);
	gsl_matrix_complex_add(params->H_q, params->env_term_6_7);
	gsl_matrix_complex_add(params->H_q, params->env_term_7_8);
	gsl_matrix_complex_add(params->H_q, params->env_term_8_1);

	gsl_matrix_complex_add(params->H_q, params->env_term_10_11);
	gsl_matrix_complex_add(params->H_q, params->env_term_11_12);
	gsl_matrix_complex_add(params->H_q, params->env_term_12_13);
	gsl_matrix_complex_add(params->H_q, params->env_term_13_14);
	gsl_matrix_complex_add(params->H_q, params->env_term_14_15);
	gsl_matrix_complex_add(params->H_q, params->env_term_15_16);
	gsl_matrix_complex_add(params->H_q, params->env_term_16_9);
...
int main(int argc, char *argv[])
{
	...
	double gamma_2_3  = 1./(freq_central*50.);			// 50 fs
	double gamma_3_4  = 1./(freq_central*50.);			// 50 fs
	double gamma_4_5  = 1./(freq_central*50.);			// 50 fs

	double gamma_5_6  = 1./(freq_central*26.*1000.);		// 26 ps

	double gamma_6_7  = 1./(freq_central*50.);			// 50 fs
	double gamma_7_8  = 1./(freq_central*50.);			// 50 fs
	double gamma_8_1  = 1./(freq_central*50.);			// 50 fs

	double gamma_10_11  = 3./(freq_central*50.);			// 50/3 fs
	double gamma_11_12  = 3./(freq_central*50.);			// 50/3 fs
	double gamma_12_13  = 3./(freq_central*50.);			// 50/3 fs

	double gamma_13_14  = 1./(freq_central*300.);			// 300 fs

	double gamma_14_15  = 3./(freq_central*10.);			// 10/3 fs
	double gamma_15_16  = 3./(freq_central*10.);			// 10/3 fs
	double gamma_16_9  = 3./(freq_central*10.);			// 10/3 fs
	...
	gsl_matrix_complex_set(H0, 10, 10, gsl_complex_rect(E[10], 0.0));
	gsl_matrix_complex_set(H0, 11, 11, gsl_complex_rect(E[11], 0.0));
	gsl_matrix_complex_set(H0, 12, 12, gsl_complex_rect(E[12], 0.0));
	gsl_matrix_complex_set(H0, 13, 13, gsl_complex_rect(E[13], 0.0));
	gsl_matrix_complex_set(H0, 14, 14, gsl_complex_rect(E[14], 0.0));
	gsl_matrix_complex_set(H0, 15, 15, gsl_complex_rect(E[15], 0.0));
	...
	gsl_matrix_complex_set(mu_init, 0, 2, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 2, 0, gsl_complex_rect(1.0, 0.0));


	gsl_matrix_complex_set(mu_init, 0, 3, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 3, 0, gsl_complex_rect(1.0, 0.0));


	gsl_matrix_complex_set(mu_init, 0, 4, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 4, 0, gsl_complex_rect(1.0, 0.0));

	gsl_matrix_complex_set(mu_init, 8, 9, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 9, 8, gsl_complex_rect(1.0, 0.0));


	gsl_matrix_complex_set(mu_init, 8, 10, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 10, 8, gsl_complex_rect(1.0, 0.0));


	gsl_matrix_complex_set(mu_init, 8, 11, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 11, 8, gsl_complex_rect(1.0, 0.0));


	gsl_matrix_complex_set(mu_init, 8, 12, gsl_complex_rect(1.0, 0.0));
	gsl_matrix_complex_set(mu_init, 12, 8, gsl_complex_rect(1.0, 0.0));
	...
	params.gamma_4_5 = gamma_4_5;
	params.gamma_5_6 = gamma_5_6;
	params.gamma_6_7 = gamma_6_7;
	params.gamma_7_8 = gamma_7_8;
	params.gamma_8_1 = gamma_8_1;
	
	params.gamma_10_11 = gamma_10_11;
	params.gamma_11_12 = gamma_11_12;
	params.gamma_12_13 = gamma_12_13;
	params.gamma_13_14 = gamma_13_14;
	params.gamma_14_15 = gamma_14_15;
	params.gamma_15_16 = gamma_15_16;
	params.gamma_16_9 = gamma_16_9;
	...
	params.env_term_4_5  = gsl_matrix_complex_alloc(N, N);
	params.env_term_5_6  = gsl_matrix_complex_alloc(N, N);
	params.env_term_6_7  = gsl_matrix_complex_alloc(N, N);
	params.env_term_7_8  = gsl_matrix_complex_alloc(N, N);
	params.env_term_8_1  = gsl_matrix_complex_alloc(N, N);

	params.env_term_10_11  = gsl_matrix_complex_alloc(N, N);
	params.env_term_11_12  = gsl_matrix_complex_alloc(N, N);
	params.env_term_12_13  = gsl_matrix_complex_alloc(N, N);
	params.env_term_13_14  = gsl_matrix_complex_alloc(N, N);
	params.env_term_14_15  = gsl_matrix_complex_alloc(N, N);
	params.env_term_15_16  = gsl_matrix_complex_alloc(N, N);
	params.env_term_16_9  = gsl_matrix_complex_alloc(N, N);
	...
	for(j=-Nf; j<Nf+1; j++)
	{
		...
		gsl_matrix_complex_set(rho_init, 8, 8, gsl_complex_rect(0.5, 0.0));	
		gsl_matrix_complex_memcpy(params.rho, params.rho_init);
		...
		for(i = 1; i< N/2; i++)
		{
			...
			PFRsum += GSL_REAL(gsl_matrix_complex_get(params.rho, i+8, i+8));

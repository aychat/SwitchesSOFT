...
if __name__ == '__main__':
    ...
    molecule = SplitOpRho_A(**qsys_params)
    gibbs_state = molecule.get_gibbs_state_A().real
    ...
    from rho_normalize import RhoSymLogNorm, RhoNormalize

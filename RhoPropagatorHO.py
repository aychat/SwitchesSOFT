...
if __name__ == '__main__':
    ...
    #     """
    #     Class to visualize the density matrix in coordinate space.
    #     """
    #
    ...
    #         ax.set_title('$\\rho_{g}(x,x^{\'})$')
    #         self.rho_g_img = ax.plot([[0]])
    #         ax.set_ylabel('$x^{\'}$ (a.u.)')
    #
    #         ax = fig.add_subplot(222)
    #         ax.set_title('$\\Re \\rho_{ge}(x,x^{\'})$')
    #         self.re_rho_ge_img = ax.plot([[0]])
    #         ax.set_ylabel('$x^{\'}$ (a.u.)')
    #
    #         ax = fig.add_subplot(223)
    #         ax.set_title('$\\Im \\rho_{ge}(x,x^{\'})$')
    #         self.im_rho_ge_img = ax.plot([[0]])
    #         ax.set_xlabel('$x$ (a.u.)')
    #         ax.set_ylabel('$x^{\'}$ (a.u.)')
    #
    #         ax = fig.add_subplot(224)
    #         ax.set_title('$\\rho_{e}(x,x^{\'})$')
    #         self.rho_e_img = ax.plot([[0]])
    #         ax.set_xlabel('$x$ (a.u.)')
    #         ax.set_ylabel('$x^{\'}$ (a.u.)')
    #
    ...
    #         )
    #
    #         self.molecule.set_initial_rho(
    #             rhoG=np.exp(-self.molecule.X2 ** 2 - self.molecule.X1 ** 2)
    #         )
    #
    ...
    #
    #         self.rho_g_img.set_array(np.diag(self.molecule.rho_g.real))
    #         self.re_rho_ge_img.set_array(np.diag(self.molecule.rho_ge.real))
    #         self.im_rho_ge_img.set_array(np.diag(self.molecule.rho_ge.imag))
    #         self.rho_e_img.set_array(np.diag(self.molecule.rho_e.real))
    #
    #         return self.rho_g_img, self.re_rho_ge_img, self.im_rho_ge_img, self.rho_e_img
    #
    #
    ...
    #                           init_func=visualizer.empty_frame, repeat=True, blit=True, interval=500)
    #
    #
    # plt.show()
